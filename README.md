...
| authorized\_external\_networks | List of external networks authorized to access this instance | `list(string)` | `[]` | no |
...
| enable\_public\_ip | Enable public IP for the AlloyDB instance. Defaults to false if not specified. | `optional(bool)` | `false` | no |
