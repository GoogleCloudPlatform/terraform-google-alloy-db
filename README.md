...
| maintenance\_update\_policy | defines the policy for system updates | <pre>object({<br>    maintenance_windows = optional(object({<br>      day = optional(string)<br>      start_time = optional(object({<br>        hours = optional(number)<br>      }))<br>    }))<br>  })</pre> | `null` | no |
